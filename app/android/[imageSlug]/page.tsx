          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
            ...
            {image.tags.filter((t: string) => !t.startsWith("badge-")).length > 0 && (
              <div style={{ padding: "10px 0 4px" }}>
                <p style={{ fontFamily: "var(--font-space, monospace)", fontSize: "0.55rem", letterSpacing: "0.28em", textTransform: "uppercase" as const, color: "var(--text-muted)", fontWeight: 700, margin: "0 0 8px" }}>Choose Your Next Obsession</p>
