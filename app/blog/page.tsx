...
export default async function BlogPage() {
  ...
  // ── Article structured data for blog list (ItemList) ──────────────────────
                    ...
                    <div className="blog-featured-thumb-wrap">
                      {thumb ? (
                        <>
                          ...
                          <img src={thumb} alt={p.title} className="blog-featured-thumb-img" loading="eager" />
                    ...
                    <Link key={post.slug} href={`/blog/${post.slug}`} className="blog-post-card">
                      {thumb ? (
                        <div className="blog-post-card-thumb-wrap">
                          {/* eslint-disable-next-line @next/next/no-img-element */}
                          <img src={thumb} alt={post.title} className="blog-post-card-thumb-img" loading="lazy" />
                        </div>
                      ) : (
                        <div className="blog-post-card-thumb-placeholder"><span>✦</span></div>
                      )}
