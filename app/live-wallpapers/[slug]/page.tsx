"use client";
// app/live-wallpapers/[slug]/page.tsx
...
export default function LiveWallpaperPlayerPage() {
  ...
  async function loadInitial(startSlug: string) {
    if (loading) return;
    setLoading(true);
    try {
  ...
  if (notFound) {
    return (
      <div style={{ minHeight: "100dvh", background: "#0d0b14", display: "flex", flexDirection: "column", gap: "16px", alignItems: "center", justifyContent: "center", color: "#8a809a", fontFamily: "monospace", fontSize: "0.85rem", textAlign: "center", padding: "0 20px" }}>
        <div>This wallpaper could not be found.</div>
        <Link href="/live-wallpapers" style={{ color: "#e8e4f8", border: "1px solid rgba(255,255,255,0.15)", borderRadius: "4px", padding: "10px 22px", textDecoration: "none", fontSize: "0.7rem", letterSpacing: "0.18em", textTransform: "uppercase" }}>
          Back to gallery
        </Link>
      </div>
    );
