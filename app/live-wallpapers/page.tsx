"use client";
// app/live-wallpapers/page.tsx  ← GALLERY (main route)
    ...
    <div className="lw-page">
      ...
      <section className="lw-grid-section">
        <div className="lw-section-head">
          <h2 className="lw-section-title">What&apos;s New on MR4K</h2>
            ...
            {items.map((item) => (
              ...
              >
                {item.thumbnailUrl ? (
                  ...
                  <div className="lw-card-placeholder">🎃</div>
                )}
                {item.hasSound && (
                  <span className="lw-card-sound">🔊</span>
                )}
