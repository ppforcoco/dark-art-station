      ...
      <div className="static-page-inner">
        ...
        <div className="static-page-body">
          <section className="static-section">
            ...
            <p>Welcome to {SITE_NAME} (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;). This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit <a href={SITE_URL}>{SITE_URL}</a> (the &quot;Site&quot;). Please read this policy carefully. If you disagree with its terms, please stop using the Site.</p>
            <p>We reserve the right to make changes to this policy at any time. The date at the top of this page reflects the most recent revision. Your continued use of the Site after any changes constitutes acceptance of the updated policy.</p>
          </section>
          <section className="static-section">
            ...
            <p>We do not use this information to identify you personally. It is used in aggregate to understand how visitors interact with the Site and to improve performance.</p>
          </section>
          ...
          <section className="static-section">
            ...
            <ul>
              <li><strong>Service providers:</strong> We may share data with trusted third-party providers who assist us in operating the Site (e.g. hosting, analytics). These providers are contractually obligated to keep your information confidential.</li>
              ...
              <li><strong>Business transfer:</strong> In the event of a merger, acquisition, or sale of assets, user information may be transferred as part of that transaction.</li>
            </ul>
          </section>
          <section className="static-section">
