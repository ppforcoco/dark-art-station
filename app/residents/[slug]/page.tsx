    ...
    <>
      ...
      <main style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 clamp(16px, 5vw, 60px) 80px" }}>
        <style>{`
          ...
          .res-portrait { width: 140px; aspect-ratio: 9/16; overflow: hidden; background: #150a2a; border: 1px solid rgba(168,85,247,0.2); position: relative; margin: 0 auto; flex-shrink: 0; }
          ...
          .res-divider { border: none; border-top: 1px solid rgba(168,85,247,0.15); margin: 56px 0; }
        `}</style>
        ...
        <div className="res-hero">
          ...
          <div style={{ paddingBottom: "8px" }}>
            <p style={{ fontFamily: "var(--font-space, monospace)", fontSize: "0.58rem", letterSpacing: "0.25em", textTransform: "uppercase", color: "#a855f7", marginBottom: "12px" }}>
              Resident of the Haunted Town
            </p>
            <h1 style={{ fontFamily: "var(--font-cinzel, serif)", color: "rgba(253,240,255,0.97)", lineHeight: 1.1, marginBottom: "14px", fontSize: "clamp(1.6rem, 5vw, 3.2rem)" }}>
              {resident.name}
            </h1>
            <p style={{ fontFamily: "var(--font-space, monospace)", color: "rgba(168,85,247,0.85)", letterSpacing: "0.07em", lineHeight: 1.7, fontSize: "clamp(0.72rem, 1.5vw, 0.9rem)" }}>
              {resident.tagline}
            </p>
          </div>
        </div>
        ...
        {wallpapers.length > 0 && (
          <section style={{ marginBottom: "64px" }}>
            <div style={{ marginBottom: "20px", display: "flex", alignItems: "baseline", gap: "16px" }}>
              <p style={{ fontFamily: "var(--font-space, monospace)", fontSize: "0.6rem", letterSpacing: "0.2em", textTransform: "uppercase", color: "#a855f7" }}>
                Their Wallpapers
              </p>
              <p style={{ fontFamily: "var(--font-space, monospace)", fontSize: "0.62rem", color: "rgba(253,240,255,0.25)", letterSpacing: "0.06em" }}>
            ...
            <div className="res-wp-grid">
              {wallpapers.map((img) => (
                <Link key={img.id} href={`/characters/${img.slug}`} className={img.deviceType === "PC" ? "res-wp-pc" : ""} style={{ display: "block", textDecoration: "none" }}>
                  ...
                  <p style={{ fontFamily: "var(--font-space, monospace)", fontSize: "0.56rem", color: "rgba(253,240,255,0.35)", marginTop: "5px", letterSpacing: "0.04em", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                    {img.title}
                  </p>
                </Link>
              ))}
        ...
        {resident.story && (
          <div style={{ marginBottom: "56px", maxWidth: "720px" }}>
            ...
            <div
              style={{ color: "rgba(253,240,255,0.72)", lineHeight: 1.9, fontSize: "clamp(0.85rem, 1.5vw, 0.95rem)" }}
        ...
        {resident.personality && (
          <div style={{ marginBottom: "64px", borderLeft: "3px solid rgba(168,85,247,0.35)", paddingLeft: "28px", maxWidth: "780px" }}>
            ...
            <div
              style={{ color: "rgba(253,240,255,0.65)", lineHeight: 1.85, fontSize: "0.9rem" }}
