...
function PinButton({ preview, seoAlt }: { preview: string; seoAlt: string }) {
  const url = `https://pinterest.com/pin/create/button/?url=https://hauntedwallpapers.com/sets/crimson-sovereign&media=${encodeURIComponent(preview)}&description=${encodeURIComponent(seoAlt)}`;
  return (
    <a
      href={url}
      target="_blank"
                ...
                <div key={w.id} className="cs-wall-item">
                  <div className="cs-wall-item__frame cs-wall-item__frame--16-9">
                    ...
                    <div className="cs-wall-item__overlay">
                      <PinButton preview={w.preview} seoAlt={w.seoAlt} />
                    </div>
                  </div>
