...
const WALLPAPERS = [
  ...
  },
  {
    ...
    seoAlt: "Complete matching dark fantasy gaming character setup kit for PC, phone and watch",
  },
];
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Complete matching dark fantasy gaming character setup kit for PC, phone and watch",
        },
      ],
    },
    twitter: {
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          inset: 0,
          background:
            "radial-gradient(ellipse 80% 50% at 50% 0%, rgba(255,46,158,0.12) 0%, transparent 65%)",
          pointerEvents: "none",
          zIndex: 0,
        }}
      />
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        >
          ...
          >
            ...
            <li style={{ color: "#341a63" }}>›</li>
            <li style={{ color: "#e4d4ff" }}>The Crimson Sovereign</li>
          </ol>
        </nav>
          ...
          <div style={{ marginTop: "clamp(28px,4vw,48px)" }}>
            <h1
              style={{
                ...
                color: "#fff3e0",
                textShadow: "0 4px 40px rgba(255,46,158,0.35), 0 0 80px rgba(255,77,109,0.12)",
              }}
            >
          ...
          <div className="cs-lore">
            ...
            <div className="cs-lore__content">
              ...
              <p className="cs-lore__body">
                ...
                <span style={{ color: "#ff2e9e", fontStyle: "italic" }}>Crimson Sovereign</span>{" "}
        ...
        {/* ── EXPLORE MORE ── */}
        <section style={{ maxWidth: "1100px", margin: "clamp(64px,8vw,96px) auto clamp(64px,10vw,120px)", padding: "0 clamp(20px,5vw,60px)" }}>
          <div className="cs-section-head">
      ...
      <style>{`
        ...
        .cs-premium-badge {
          ...
          color: #ff7a18;
          background: linear-gradient(135deg, rgba(255,122,24,0.12) 0%, rgba(255,46,158,0.12) 100%);
          border: 1px solid rgba(255,122,24,0.4);
          padding: 5px 12px;
          border-radius: 2px;
          font-weight: 700;
          box-shadow: 0 0 16px rgba(255,122,24,0.15);
        ...
        @keyframes cs-premium-pulse {
          ...
          50% { box-shadow: 0 0 28px rgba(255,122,24,0.3), 0 0 48px rgba(255,46,158,0.12); }
        }
        ...
        .cs-wall-item__frame:hover {
          ...
          box-shadow: 0 0 32px rgba(255,46,158,0.12);
        }
        ...
        @keyframes cs-glow-desk {
          ...
          50%      { box-shadow: 0 0 0 4px #170a2e, 0 0 0 6px rgba(20,20,40,0.9), 0 0 80px rgba(0,0,0,0.7), 0 0 120px rgba(255,46,158,0.15); }
        }
        ...
        @keyframes cs-glow-phone {
          ...
          50%      { box-shadow: 0 0 0 3px #170a2e, 0 0 0 5px rgba(20,20,40,0.9), 0 12px 48px rgba(0,0,0,0.8), 0 0 50px rgba(255,46,158,0.18); }
        }
        .cs-collage__island {
          position: absolute;
          top: 8px;
        ...
        @keyframes cs-glow-watch {
          ...
          50%      { box-shadow: 0 0 0 3px #170a2e, 0 0 0 5px rgba(20,20,40,0.9), 0 8px 32px rgba(0,0,0,0.75), 0 0 40px rgba(255,46,158,0.2); }
        }
        ...
        .cs-lore::before {
          ...
          position: absolute;
          inset: 0;
          background: radial-gradient(ellipse 60% 80% at 0% 50%, rgba(255,46,158,0.05), transparent);
          pointer-events: none;
        }
        .cs-lore__bar {
        ...
        .cs-why::before {
          ...
          position: absolute;
          inset: 0;
          background: radial-gradient(ellipse 70% 60% at 100% 50%, rgba(255,46,158,0.05), transparent);
          pointer-events: none;
        }
        .cs-why__title {
          font-family: var(--font-cinzel, serif);
        ...
        .cs-cta-block__glow {
          position: absolute;
          inset: 0;
          background: radial-gradient(ellipse 60% 60% at 50% 50%, rgba(255,46,158,0.09), transparent);
          pointer-events: none;
        }
        ...
        .cs-explore-card:hover {
          border-color: rgba(255,46,158,0.35);
          box-shadow: 0 0 30px rgba(255,46,158,0.05);
        }
