    ...
    <main style={{ minHeight: "100vh", backgroundColor: "var(--bg-primary, #0d0d14)", color: "var(--text-primary, #e0e0f8)", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <section id="download-kit"<section style={{ maxWidth: "1100px", margin: "clamp(48px,7vw,80px) auto clamp(64px,10vw,120px)", padding: "0 clamp(20px,5vw,60px)" }}>
          <div id="download-kit" className="gp-cta-block">
        ...
        {/* ── BACK LINK ── */}
        <div style={{ maxWidth: "1100px", margin: "clamp(48px,7vw,80px) auto 0", padding: "0 clamp(20px,5vw,60px) 48px", borderTop: "1px solid rgba(232,124,30,0.15)", paddingTop: "32px" }}>
