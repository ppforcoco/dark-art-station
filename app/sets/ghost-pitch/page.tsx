...
export default function GhostPitchPage() {
  ...
  return (
    <main style={{ minHeight: "100vh", backgroundColor: "var(--bg-primary, #1a0b2e)", color: "var(--text-primary, #ede4ff)", position: "relative", overflow: "hidden" }}>
      ...
      {/* Ember radial glow */}
      <div aria-hidden="true" style={{ position: "fixed", inset: 0, background: "radial-gradient(ellipse 80% 50% at 50% 0%, rgba(255,167,38,0.09) 0%, transparent 65%)", pointerEvents: "none", zIndex: 0 }} />
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <nav aria-label="Breadcrumb" style={{ maxWidth: "1100px", margin: "0 auto", padding: "clamp(28px,5vw,48px) clamp(20px,5vw,60px) 0" }}>
          <ol style={{ listStyle: "none", margin: 0, padding: 0, display: "flex", alignItems: "center", gap: "6px", fontFamily: "var(--font-space, monospace)", fontSize: "0.55rem", letterSpacing: "0.18em", textTransform: "uppercase" }}>
            ...
            <li style={{ color: "#341a63" }}>›</li>
            <li style={{ color: "#e4d4ff" }}>Ghost Pitch</li>
          </ol>
        </nav>
        ...
        <header style={{ maxWidth: "1100px", margin: "0 auto", padding: "clamp(32px,5vw,56px) clamp(20px,5vw,60px) 0" }}>
          ...
          <div style={{ marginTop: "clamp(28px,4vw,48px)" }}>
            <h1 style={{ fontFamily: "var(--font-cinzel, serif)", fontSize: "clamp(2rem, 5vw, 3.8rem)", fontWeight: 900, lineHeight: 1.0, margin: "0 0 8px", letterSpacing: "0.04em", color: "#fff3e0", textShadow: "0 4px 40px rgba(255,167,38,0.25)" }}>
              The Ghost Pitch
            </h1>
            <p style={{ fontFamily: "var(--font-space, monospace)", fontSize: "0.72rem", letterSpacing: "0.22em", textTransform: "uppercase", color: "#ffa726", margin: "0 0 20px" }}>
          ...
          <div className="gp-lore">
            ...
            <div className="gp-lore__content">
              ...
              <p className="gp-lore__body">
                ...
                <span style={{ color: "#ffa726", fontStyle: "italic" }}>"Ghost Pitch."</span>
              </p>
              <p className="gp-lore__body">
            ...
            {[
              ...
              <div key={phase.num} className="gp-phase">
                ...
                <div className="gp-phase__body">
                  ...
                  <p className="gp-phase__best"><span style={{ color: "#7c5cbf" }}>Best for: </span>{phase.best}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <style>{`
        ...
        .gp-wall-item__frame { position: relative; overflow: hidden; border: 1px solid rgba(255,167,38,0.2); background: #120826; transition: border-color 0.3s ease, box-shadow 0.3s ease; cursor: pointer; }
        .gp-wall-item__frame:hover { border-color: rgba(255,167,38,0.55); box-shadow: 0 0 32px rgba(255,167,38,0.12); }
        ...
        .gp-wall-item__corners span { position: absolute; width: 12px; height: 12px; border-color: rgba(255,167,38,0.55); border-style: solid; }
        ...
        .gp-collage__desktop { position: relative; border-radius: 4px; overflow: hidden; border: 2px solid #1f1040; box-shadow: 0 0 0 4px #170a2e, 0 0 0 6px rgba(20,20,10,0.9), 0 0 80px rgba(0,0,0,0.7); animation: gp-glow-desk 4s ease-in-out infinite; aspect-ratio: 16/9; background: #120826; width: 100%; }
        @keyframes gp-glow-desk { 0%,100% { box-shadow: 0 0 0 4px #170a2e, 0 0 0 6px rgba(20,20,10,0.9), 0 0 80px rgba(0,0,0,0.7); } 50% { box-shadow: 0 0 0 4px #170a2e, 0 0 0 6px rgba(20,20,10,0.9), 0 0 80px rgba(0,0,0,0.7), 0 0 100px rgba(40,20,0,0.25); } }
        ...
        .gp-collage__phone-shell { position: relative; width: 100%; aspect-ratio: 9/16; border-radius: 28px; overflow: hidden; border: 2px solid #1f1040; background: #120826; animation: gp-glow-phone 4s ease-in-out infinite 1s; box-shadow: 0 0 0 3px #170a2e, 0 0 0 5px rgba(20,20,10,0.9), 0 12px 48px rgba(0,0,0,0.8); }
        @keyframes gp-glow-phone { 0%,100% { box-shadow: 0 0 0 3px #170a2e, 0 0 0 5px rgba(20,20,10,0.9), 0 12px 48px rgba(0,0,0,0.8); } 50% { box-shadow: 0 0 0 3px #170a2e, 0 0 0 5px rgba(20,20,10,0.9), 0 12px 48px rgba(0,0,0,0.8), 0 0 50px rgba(40,20,0,0.2); } }
        ...
        .gp-collage__watch-shell { position: relative; width: 100%; aspect-ratio: 1/1; border-radius: 32% / 28%; overflow: hidden; border: 2px solid #1f1040; background: #120826; animation: gp-glow-watch 4s ease-in-out infinite 2s; box-shadow: 0 0 0 3px #170a2e, 0 0 0 5px rgba(20,20,10,0.9), 0 8px 32px rgba(0,0,0,0.75); }
        @keyframes gp-glow-watch { 0%,100% { box-shadow: 0 0 0 3px #170a2e, 0 0 0 5px rgba(20,20,10,0.9), 0 8px 32px rgba(0,0,0,0.75); } 50% { box-shadow: 0 0 0 3px #170a2e, 0 0 0 5px rgba(20,20,10,0.9), 0 8px 32px rgba(0,0,0,0.75), 0 0 40px rgba(40,20,0,0.2); } }
        ...
        /* Lore */
        .gp-lore { display: grid; grid-template-columns: 3px 1fr; gap: 28px; background: rgba(255,255,255,0.02); border: 1px solid rgba(255,167,38,0.15); padding: clamp(24px,4vw,40px); position: relative; overflow: hidden; }
        ...
        .gp-lore__bar { background: linear-gradient(to bottom, transparent, #ffa726, transparent); border-radius: 2px; flex-shrink: 0; }
        .gp-lore__title { font-family: var(--font-cinzel, serif); font-size: clamp(1.1rem,2vw,1.5rem); font-weight: 700; color: #fff3e0; margin: 0 0 16px; letter-spacing: 0.04em; }
        .gp-lore__body { font-family: var(--font-cormorant, serif); font-size: clamp(1rem,1.5vw,1.1rem); line-height: 1.8; color: rgba(237,228,255,0.65); margin: 0 0 12px; }
        .gp-lore__body:last-child { margin-bottom: 0; }

        /* Section head */
        .gp-section-head { margin-bottom: clamp(28px,4vw,48px); }
        .gp-section-eyebrow { display: block; font-family: var(--font-space, monospace); font-size: 0.56rem; letter-spacing: 0.26em; text-transform: uppercase; color: #ffa726; margin-bottom: 10px; }
        .gp-section-title { font-family: var(--font-cinzel, serif); font-size: clamp(1.4rem,3vw,2.2rem); font-weight: 700; color: #fff3e0; margin: 0; letter-spacing: 0.04em; }
        ...
        .gp-phase__text { font-family: var(--font-cormorant, serif); font-size: clamp(0.95rem,1.4vw,1.05rem); line-height: 1.8; color: rgba(237,228,255,0.62); margin: 0 0 10px; }
        .gp-phase__best { font-family: var(--font-space, monospace); font-size: 0.56rem; letter-spacing: 0.12em; color: rgba(237,228,255,0.5); margin: 0; }

        /* Why */
        .gp-why { border: 1px solid rgba(255,167,38,0.15); padding: clamp(28px,4vw,48px); position: relative; overflow: hidden; }
        ...
        .gp-why__title { font-family: var(--font-cinzel, serif); font-size: clamp(1.2rem,2.5vw,1.8rem); font-weight: 700; color: #fff3e0; margin: 0 0 20px; letter-spacing: 0.04em; }
        .gp-why__body { font-family: var(--font-cormorant, serif); font-size: clamp(0.98rem,1.5vw,1.08rem); line-height: 1.8; color: rgba(237,228,255,0.65); margin: 0 0 16px; max-width: 720px; }
        .gp-why__body:last-of-type { margin-bottom: 24px; }
        .gp-why__tags { display: flex; flex-wrap: wrap; gap: 8px; }
        .gp-why__tag { font-family: var(--font-space, monospace); font-size: 0.56rem; letter-spacing: 0.12em; color: rgba(255,167,38,0.7); }

        /* CTA — ember */
        .gp-cta-block { position: relative; border: 1px solid rgba(255,167,38,0.35); padding: clamp(32px,5vw,56px); text-align: center; overflow: hidden; }
        .gp-cta-block__glow { position: absolute; inset: 0; background: radial-gradient(ellipse 60% 60% at 50% 50%, rgba(255,167,38,0.08), transparent); pointer-events: none; }
        .gp-cta-block__eyebrow { display: block; font-family: var(--font-space, monospace); font-size: 0.56rem; letter-spacing: 0.24em; text-transform: uppercase; color: #7c5cbf; margin-bottom: 14px; position: relative; }
        .gp-cta-block__title { font-family: var(--font-cinzel, serif); font-size: clamp(1.4rem,3vw,2.2rem); font-weight: 700; color: #fff3e0; margin: 0 0 10px; position: relative; }
        .gp-cta-block__sub { font-family: var(--font-cormorant, serif); font-size: 1rem; color: rgba(237,228,255,0.55); margin: 0 0 28px; position: relative; }
        .gp-cta-block__btns { display: flex; flex-wrap: wrap; gap: 12px; justify-content: center; position: relative; }
        .gp-cta-btn { display: inline-flex; align-items: center; padding: 12px 22px; background: transparent; color: rgba(237,228,255,0.8); border: 1px solid rgba(255,167,38,0.35); border-radius: 2px; font-family: var(--font-space, monospace); font-size: 0.6rem; letter-spacing: 0.14em; text-transform: uppercase; text-decoration: none; transition: all 0.25s ease; cursor: pointer; }
        .gp-cta-btn:hover { border-color: rgba(255,167,38,0.75); color: #fff; background: rgba(255,167,38,0.1); box-shadow: 0 0 20px rgba(255,167,38,0.2); }

        /* Explore */
        .gp-explore-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(220px, 1fr)); gap: clamp(16px,2.5vw,24px); }
        .gp-explore-card { background: rgba(255,255,255,0.02); border: 1px solid rgba(255,167,38,0.12); overflow: hidden; transition: border-color 0.3s, box-shadow 0.3s; text-decoration: none; display: block; color: inherit; }
        .gp-explore-card--link:hover { border-color: rgba(255,167,38,0.35); box-shadow: 0 0 30px rgba(60,30,0,0.08); }
        ...
        .gp-explore-card__badge { position: absolute; top: 8px; left: 10px; font-family: var(--font-space, monospace); font-size: 0.48rem; letter-spacing: 0.18em; text-transform: uppercase; color: #fff3e0; background: rgba(0,0,0,0.75); border: 1px solid rgba(255,167,38,0.35); padding: 2px 7px; border-radius: 2px; }
        .gp-explore-card__body { padding: clamp(14px,2vw,20px); }
        .gp-explore-card__title { font-family: var(--font-cinzel, serif); font-size: 0.95rem; font-weight: 700; color: #fff3e0; margin: 0 0 8px; letter-spacing: 0.04em; }
        .gp-explore-card__desc { font-family: var(--font-cormorant, serif); font-size: 0.9rem; line-height: 1.65; color: rgba(237,228,255,0.5); margin: 0 0 10px; }
        .gp-explore-card__cta { font-family: var(--font-space, monospace); font-size: 0.56rem; letter-spacing: 0.16em; text-transform: uppercase; color: #ffa726; }

        /* Set badge */
        .gp-set-badge { display: flex; align-items: center; gap: 12px; margin-bottom: 24px; flex-wrap: wrap; }
        .gp-set-badge__num { font-family: var(--font-space, monospace); font-size: clamp(0.75rem, 1.5vw, 0.9rem); letter-spacing: 0.28em; text-transform: uppercase; color: #ffa726; background: rgba(255,167,38,0.08); border: 1px solid rgba(255,167,38,0.35); padding: 6px 16px; border-radius: 2px; font-weight: 700; }
        .gp-set-badge__div { color: rgba(255,167,38,0.4); font-size: 1.2rem; }
        .gp-set-badge__sub { font-family: var(--font-cinzel, serif); font-size: clamp(0.9rem, 2vw, 1.2rem); letter-spacing: 0.12em; text-transform: uppercase; color: #fff3e0; font-weight: 700; }
