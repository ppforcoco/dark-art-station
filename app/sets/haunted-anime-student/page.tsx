...
function PinButton({ preview, seoAlt }: { preview: string; seoAlt: string }) {
  const url = `https://pinterest.com/pin/create/button/?url=https://hauntedwallpapers.com/sets/haunted-anime-student&media=${encodeURIComponent(preview)}&description=${encodeURIComponent(seoAlt)}`;
  return (
    <a
      href={url}
      target="_blank"
