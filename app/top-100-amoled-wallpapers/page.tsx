...
export const metadata: Metadata = {
  ...
  description: "100 pure black AMOLED wallpapers from the Black Shadow World collection. True black backgrounds that save battery, kill the light, and look stunning on any OLED screen. 4K download.",
  ...
  openGraph: {
    ...
    description: "100 pure black AMOLED wallpapers. True black backgrounds for OLED screens. 4K download.",
    url: `${SITE_URL}/top-100-amoled-wallpapers`,
    siteName: "Haunted Wallpapers",
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Top 100 AMOLED Wallpapers | Black Shadow World", description: "100 pure black AMOLED wallpapers for OLED screens. 4K download." },
      ...
      <main style={{ maxWidth: "1280px", margin: "0 auto", padding: "40px clamp(16px,5vw,60px) 80px" }}>
        ...
        <div style={{ maxWidth: "780px", marginBottom: "60px" }}>
          <div style={{ borderLeft: "3px solid rgba(255,255,255,0.15)", paddingLeft: "24px", marginBottom: "40px" }}>
            ...
            <p style={{ color: "rgba(253,240,255,0.8)", fontSize: "0.95rem", lineHeight: 1.9 }}>
          ...
          <div>
            ...
            {[
              ...
              { q: "How do I download a wallpaper?", a: "Yes. All 100 wallpapers in this collection are available for personal use as device backgrounds. Every image is original dark art with no copyright issues or watermarks." },
