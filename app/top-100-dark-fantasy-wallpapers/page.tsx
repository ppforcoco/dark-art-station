  ...
  return (
    <>
      ...
      <main style={{ maxWidth: "1280px", margin: "0 auto", padding: "40px clamp(16px,5vw,60px) 80px" }}>
        ...
        {/* Hero */}
        <div style={{ marginBottom: "48px", borderLeft: "3px solid #ffd23f", paddingLeft: "24px" }}>
          <p style={{ fontFamily: "var(--font-space,monospace)", fontSize: "0.65rem", letterSpacing: "0.2em", textTransform: "uppercase", color: "#ffd23f", marginBottom: "12px" }}>The Haunted Town Collection</p>
          <h1 style={{ fontFamily: "var(--font-cinzel,serif)", fontSize: "clamp(1.8rem,4vw,3rem)", color: "rgba(253,240,255,0.95)", lineHeight: 1.15, marginBottom: "16px" }}>
            Top 100 Dark Fantasy Wallpapers
          </h1>
          <p style={{ fontFamily: "var(--font-cormorant,serif)", fontSize: "1.1rem", fontStyle: "italic", color: "rgba(253,240,255,0.55)", marginBottom: "16px", maxWidth: "600px" }}>
            The Town That Doesn't Appear on Any Map.
          </p>
          <p style={{ fontFamily: "var(--font-space,monospace)", fontSize: "0.65rem", letterSpacing: "0.18em", textTransform: "uppercase", color: "rgba(253,240,255,0.3)" }}>
            {images.length} wallpapers · Forgotten kingdoms · Cursed forests · 4K
          </p>
        </div>
          ...
          {images.map((img) => {
            ...
            return (
              <Link key={img.id} href={href} style={{ display: "block", textDecoration: "none" }}>
                ...
                <p style={{ fontFamily: "var(--font-space,monospace)", fontSize: "0.58rem", color: "rgba(253,240,255,0.6)", marginTop: "5px", letterSpacing: "0.03em", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{img.title}</p>
                {shortDesc && <p style={{ fontFamily: "var(--font-space,monospace)", fontSize: "0.52rem", color: "rgba(253,240,255,0.3)", marginTop: "2px", letterSpacing: "0.02em", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{shortDesc}</p>}
              </Link>
            );
          })}
        </div>
        ...
        {/* Intro */}
        <div style={{ maxWidth: "720px", marginBottom: "48px", borderLeft: "1px solid rgba(255,210,63,0.2)", paddingLeft: "20px" }}>
          <p style={{ color: "rgba(253,240,255,0.7)", fontSize: "0.9rem", lineHeight: 1.9, marginBottom: "12px" }}>
          ...
          <p style={{ color: "rgba(253,240,255,0.7)", fontSize: "0.9rem", lineHeight: 1.9 }}>
        ...
        <div style={{ maxWidth: "780px", marginBottom: "60px" }}>
          <div style={{ borderLeft: "3px solid rgba(255,210,63,0.25)", paddingLeft: "24px", marginBottom: "40px" }}>
            <p style={{ fontFamily: "var(--font-space,monospace)", fontSize: "0.6rem", letterSpacing: "0.2em", textTransform: "uppercase", color: "rgba(255,210,63,0.5)", marginBottom: "20px" }}>About This Collection</p>
            <p style={{ color: "rgba(253,240,255,0.8)", fontSize: "0.95rem", lineHeight: 1.9, marginBottom: "16px" }}>
            ...
            <p style={{ fontFamily: "var(--font-space,monospace)", fontSize: "0.6rem", letterSpacing: "0.12em", color: "rgba(253,240,255,0.25)", marginTop: "24px" }}>
          ...
          {/* FAQ */}
          <div>
            <p style={{ fontFamily: "var(--font-space,monospace)", fontSize: "0.6rem", letterSpacing: "0.2em", textTransform: "uppercase", color: "rgba(255,210,63,0.4)", marginBottom: "24px" }}>Frequently Asked</p>
            {[
              ...
              { q: "How do I download a wallpaper?", a: "Yes. All 100 wallpapers are available for personal use as device backgrounds. Every image is original AI-crafted dark art with no watermarks or copyright issues." },
              ...
              <div key={q} style={{ borderTop: "1px solid rgba(255,210,63,0.08)", paddingTop: "20px", marginBottom: "20px" }}>
                <p style={{ fontFamily: "var(--font-cinzel,serif)", fontSize: "0.85rem", color: "rgba(253,240,255,0.85)", marginBottom: "10px" }}>{q}</p>
                <p style={{ fontFamily: "var(--font-space,monospace)", fontSize: "0.72rem", color: "rgba(253,240,255,0.45)", lineHeight: 1.8 }}>{a}</p>
              </div>
            ))}
          </div>

          {/* Cross-links */}
          <div style={{ borderTop: "1px solid rgba(255,210,63,0.08)", paddingTop: "32px", marginTop: "20px", display: "flex", flexDirection: "column", gap: "12px" }}>
            <p style={{ fontFamily: "var(--font-space,monospace)", fontSize: "0.6rem", letterSpacing: "0.2em", textTransform: "uppercase", color: "rgba(255,210,63,0.3)", marginBottom: "8px" }}>Explore More</p>
            <Link href="/top-100-horror-wallpapers" style={{ color: "rgba(255,46,158,0.8)", fontFamily: "var(--font-space,monospace)", fontSize: "0.75rem", textDecoration: "none", letterSpacing: "0.05em" }}>
