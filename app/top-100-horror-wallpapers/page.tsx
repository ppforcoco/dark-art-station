    ...
    <>
      ...
      <main style={{ maxWidth: "1280px", margin: "0 auto", padding: "40px clamp(16px,5vw,60px) 80px" }}>
        ...
        <div style={{ marginBottom: "48px", borderLeft: "3px solid #ff2e9e", paddingLeft: "24px" }}>
          <p style={{ fontFamily: "var(--font-space,monospace)", fontSize: "0.65rem", letterSpacing: "0.2em", textTransform: "uppercase", color: "#ff2e9e", marginBottom: "12px" }}>The Haunted Town Static Collection</p>
          ...
          <p style={{ fontFamily: "var(--font-space,monospace)", fontSize: "0.65rem", letterSpacing: "0.18em", textTransform: "uppercase", color: "rgba(253,240,255,0.3)" }}>
            {images.length} wallpapers · Analog horror · Liminal spaces · 4K
          </p>
        </div>
        ...
        {/* Intro */}
        <div style={{ maxWidth: "720px", marginBottom: "48px", borderLeft: "1px solid rgba(255,46,158,0.2)", paddingLeft: "20px" }}>
        ...
        <div style={{ maxWidth: "780px", marginBottom: "60px" }}>
          <div style={{ borderLeft: "3px solid rgba(255,46,158,0.25)", paddingLeft: "24px", marginBottom: "40px" }}>
            <p style={{ fontFamily: "var(--font-space,monospace)", fontSize: "0.6rem", letterSpacing: "0.2em", textTransform: "uppercase", color: "rgba(255,46,158,0.5)", marginBottom: "20px" }}>About This Collection</p>
          ...
          {/* FAQ */}
          <div>
            <p style={{ fontFamily: "var(--font-space,monospace)", fontSize: "0.6rem", letterSpacing: "0.2em", textTransform: "uppercase", color: "rgba(255,46,158,0.4)", marginBottom: "24px" }}>Frequently Asked</p>
            {[
              ...
              <div key={q} style={{ borderTop: "1px solid rgba(255,46,158,0.08)", paddingTop: "20px", marginBottom: "20px" }}>
          ...
          {/* Cross-links */}
          <div style={{ borderTop: "1px solid rgba(255,46,158,0.08)", paddingTop: "32px", marginTop: "20px", display: "flex", flexDirection: "column", gap: "12px" }}>
            <p style={{ fontFamily: "var(--font-space,monospace)", fontSize: "0.6rem", letterSpacing: "0.2em", textTransform: "uppercase", color: "rgba(255,46,158,0.3)", marginBottom: "8px" }}>Explore More</p>
            <Link href="/top-100-dark-fantasy-wallpapers" style={{ color: "rgba(255,210,63,0.8)", fontFamily: "var(--font-space,monospace)", fontSize: "0.75rem", textDecoration: "none", letterSpacing: "0.05em" }}>
