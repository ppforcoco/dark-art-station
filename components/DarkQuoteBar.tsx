...
const QUOTES = [
  ...
  { text: "In the depth of winter, I finally learned that within me there lay an invincible summer.", author: "Camus" },
  ...
  { text: "She is a beautiful piece of broken chaos, and somehow she is exactly what I need.", author: "Unknown" },
  ...
  { text: "Some people create their own storms, then get upset when it rains.", author: "Unknown" },
