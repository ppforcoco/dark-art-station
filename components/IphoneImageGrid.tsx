  ...
  return (
    <button
      ...
      style={{
        ...
        background: saved ? "rgba(255,46,158,0.85)" : "rgba(16,8,34,0.72)",
  ...
  return (
    <div className={gridClassName ?? defaultGridClass} style={gridStyle}>
      {visibleImages.map((img, idx) => {
        ...
        const CardTag: any = Link;
        const cardExtraProps = { href: `${hrefPrefix}/${img.slug}`, prefetch: false };
            ...
            >
              ...
              {isPremium && (
                <span style={{
                  ...
                  color: "#190c30", background: "#ffd23f",
