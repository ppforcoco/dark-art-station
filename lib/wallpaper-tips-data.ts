// Separated from WallpaperTips.tsx so the component bundle is smaller.
// Next.js will tree-shake this into a separate chunk loaded only when
// WallpaperTips mounts — not on the critical path.
